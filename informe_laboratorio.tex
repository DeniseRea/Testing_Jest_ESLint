...
% Programación Avanzada - Universidad de las Fuerzas Armadas ESPE
%=============================================
...
\fancyhead[R]{\small\textcolor{darkBlue}{Programación Avanzada}}
\fancyfoot[C]{\thepage}
...
El presente informe documenta el desarrollo de la Práctica N° 2 del laboratorio de Programación Avanzada, cuyo enfoque principal fue la aplicación de técnicas de \textbf{verificación y validación} sobre el código fuente de una API REST para gestión de usuarios.
...
Se ejecutaron las pruebas mediante el comando \texttt{npm test}, obteniendo los siguientes resultados:
...
\begin{tabular}{ccc}
    ...
    \textbf{Mesias Mariscal} & & \textbf{Denise Rea} \\
    Estudiante & & Estudiante \\[2cm]
    
    \multicolumn{3}{c}{\rule{5cm}{0.4pt}} \\
    \multicolumn{3}{c}{\textbf{Julio Viche}} \\
    \multicolumn{3}{c}{Estudiante} \\[2cm]
    
    \multicolumn{3}{c}{\rule{6cm}{0.4pt}} \\
    \multicolumn{3}{c}{\textbf{Ing. Enrique Calvopiña, MsC.}} \\
    \multicolumn{3}{c}{Docente} \\
\end{tabular}
\end{center}
